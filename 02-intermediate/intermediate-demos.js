...
<paper-card>
  <div id="lifecycle-demo" class="demo">
    ...
    <button>Toggle lifecycle demo</button>
  </div>
</paper-card>
<paper-card>
  <div class="demo">
...
class IntermediateDemos extends HTMLElement {
  ...
  connectedCallback() {
    this.renderLifecycleDemo();
  }

  renderLifecycleDemo() {
    const el = this.shadowRoot.querySelector("#lifecycle-demo");
    console.dir(el);
    el.innerHTML = `
      <a href="https://stackblitz.com/edit/open-wc-lit-demos?file=02-intermediate%2F03-lifecycle.js" target="_blank"><h2>03 Lifecycle</h2></a>
      <button>Toggle lifecycle demo</button>
      ${this.showLifecycleDemo ? `<lifecycle-demo></lifecycle-demo>` : ''}
    `;
